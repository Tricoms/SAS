...
%macro data_specs(
	...
	/* added Dave Crowley to make larger for SASHELP library 
	Ibufsize is now set to max */
    options ibufsize=31000 ibufno=10; run;
...
(
           LIBN=AGG442,
           OUT=d:\data\data_dictionary_ITRM.xlsx,
           INDEX=,
           CAT_THRESHOLD=10,
           WHERE=,
           FORMAT=long,
